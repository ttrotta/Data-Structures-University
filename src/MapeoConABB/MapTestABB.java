...
public class MapTestABB {

	private MapABB<Integer, Integer> s; // interface

	private Integer n1, n2, n3;

	private Integer i1, i2, i3;

	private MapABB<Integer, Integer> getMapeo() {
		return new MapeoConABB<Integer, Integer>(new MiComparador<Integer>());
	}
	...
	{ Iterable<EntryABB<Integer,Integer>> It_entries;
	  ...
	  //Mapeo vac�o
		...
		//Testeando entries()
		 ...
		 for(EntryABB<Integer,Integer> en :It_entries)
